...
class ManageBookingPendingPayment extends StatefulWidget {
  const ManageBookingPendingPayment({super.key});

  @override
  _ManageBookingPendingPayment createState() => _ManageBookingPendingPayment();
}

class _ManageBookingPendingPayment extends State<ManageBookingPendingPayment> {
  ...
  Future<List<Map<String, dynamic>>> _getBookings() async {
    ...
    List<Map<String, dynamic>> bookings = bookingsSnapshot.docs
        ...
        .where((booking) => booking['status'] == 'pending payment')
        .toList();
                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(
                          DropdownButton<String>(
                            ...
                            items: <String>['pending payment', 'payment done']
