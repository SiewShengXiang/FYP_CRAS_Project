...
class PendingRefundPage extends StatefulWidget {
  const PendingRefundPage({super.key});

  @override
  _PendingRefundPageState createState() => _PendingRefundPageState();
}

class _PendingRefundPageState extends State<PendingRefundPage> {
  ...
  Future<List<Map<String, dynamic>>> _getBookings() async {
    ...
    List<Map<String, dynamic>> bookings = bookingsSnapshot.docs
        ...
        .where((booking) => booking['status'] == 'pending refund')
        .toList();
